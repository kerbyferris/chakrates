...
var args27858 = [];
var len__25873__auto___27862 = arguments.length;
var i__25874__auto___27863 = (0);
while(true){
if((i__25874__auto___27863 < len__25873__auto___27862)){
args27858.push((arguments[i__25874__auto___27863]));

var G__27864 = (i__25874__auto___27863 + (1));
i__25874__auto___27863 = G__27864;
continue;
} else {
}
break;
...
var G__27861 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__27861,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__27861;
}
});
...
var len__25873__auto___27869 = arguments.length;
var i__25874__auto___27870 = (0);
while(true){
if((i__25874__auto___27870 < len__25873__auto___27869)){
args__25880__auto__.push((arguments[i__25874__auto___27870]));

var G__27871 = (i__25874__auto___27870 + (1));
i__25874__auto___27870 = G__27871;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq27866){
var G__27867 = cljs.core.first.call(null,seq27866);
var seq27866__$1 = cljs.core.next.call(null,seq27866);
var G__27868 = cljs.core.first.call(null,seq27866__$1);
var seq27866__$2 = cljs.core.next.call(null,seq27866__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__27867,G__27868,seq27866__$2);
});
...
var line = cljs.core.get.call(null,map__27875__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__27875__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__27875,map__27875__$1,file,line,column){
return (function (p1__27872_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__27872_SHARP_));
});})(map__27875,map__27875__$1,file,line,column))
...
var temp__4657__auto___27877 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___27877)){
var message_27878 = temp__4657__auto___27877;
cljs.core.println.call(null,message_27878);
} else {
}
...
var temp__4657__auto___27879 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___27879)){
var message_27880 = temp__4657__auto___27879;
cljs.core.println.call(null,message_27880);
} else {
}
...
var G__27890 = exception.stack;
var G__27890__$1 = (((G__27890 == null))?null:clojure.string.split_lines.call(null,G__27890));
var G__27890__$2 = (((G__27890__$1 == null))?null:cljs.core.get.call(null,G__27890__$1,depth));
if((G__27890__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__27890__$2);
}
} else {
...
var vec__27891 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__27891,(0),null);
var column = cljs.core.nth.call(null,vec__27891,(1),null);
var vec__27894 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__27894,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__27894,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__27894,(2),null);
...
var m__$1 = (function (){var G__27898 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__27898) {
case "fail":
...
var G__27904 = (function (){var G__27903 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__27903);
} else {
return G__27903;
}
})();
...
return cljs.core.vary_meta.call(null,G__27906,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e27909){var e = e27909;
var G__27910 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__27910) {
...
var vec__27915 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__27915,(0),null);
var types = vec__27915;
...
return cljs.core.map.call(null,(function (p__27927){
var vec__27928 = p__27927;
var ns = cljs.core.nth.call(null,vec__27928,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__27928,(1),null);
return ((function (vec__27928,ns,vars__$1){
return (function (){
...
var G__27931 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__27931) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__27931,env,once_fixtures,each_fixtures,vec__27928,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__27931,env,once_fixtures,each_fixtures,vec__27928,ns,vars__$1){
return (function (){
var seq__27932 = cljs.core.seq.call(null,vars__$1);
var chunk__27933 = null;
var count__27934 = (0);
var i__27935 = (0);
while(true){
if((i__27935 < count__27934)){
var v = cljs.core._nth.call(null,chunk__27933,i__27935);
var temp__4657__auto___27937 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___27937)){
var t_27938 = temp__4657__auto___27937;
each_fixture_fn.call(null,((function (seq__27932,chunk__27933,count__27934,i__27935,t_27938,temp__4657__auto___27937,v,each_fixture_fn,G__27931,env,once_fixtures,each_fixtures,vec__27928,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27938)));
});})(seq__27932,chunk__27933,count__27934,i__27935,t_27938,temp__4657__auto___27937,v,each_fixture_fn,G__27931,env,once_fixtures,each_fixtures,vec__27928,ns,vars__$1))
);
} else {
}

var G__27939 = seq__27932;
var G__27940 = chunk__27933;
var G__27941 = count__27934;
var G__27942 = (i__27935 + (1));
seq__27932 = G__27939;
chunk__27933 = G__27940;
count__27934 = G__27941;
i__27935 = G__27942;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__27932);
if(temp__4657__auto__){
var seq__27932__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27932__$1)){
var c__25609__auto__ = cljs.core.chunk_first.call(null,seq__27932__$1);
var G__27943 = cljs.core.chunk_rest.call(null,seq__27932__$1);
var G__27944 = c__25609__auto__;
var G__27945 = cljs.core.count.call(null,c__25609__auto__);
var G__27946 = (0);
seq__27932 = G__27943;
chunk__27933 = G__27944;
count__27934 = G__27945;
i__27935 = G__27946;
continue;
} else {
var v = cljs.core.first.call(null,seq__27932__$1);
var temp__4657__auto___27947__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___27947__$1)){
var t_27948 = temp__4657__auto___27947__$1;
each_fixture_fn.call(null,((function (seq__27932,chunk__27933,count__27934,i__27935,t_27948,temp__4657__auto___27947__$1,v,seq__27932__$1,temp__4657__auto__,each_fixture_fn,G__27931,env,once_fixtures,each_fixtures,vec__27928,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27948)));
});})(seq__27932,chunk__27933,count__27934,i__27935,t_27948,temp__4657__auto___27947__$1,v,seq__27932__$1,temp__4657__auto__,each_fixture_fn,G__27931,env,once_fixtures,each_fixtures,vec__27928,ns,vars__$1))
);
} else {
}

var G__27949 = cljs.core.next.call(null,seq__27932__$1);
var G__27950 = null;
var G__27951 = (0);
var G__27952 = (0);
seq__27932 = G__27949;
chunk__27933 = G__27950;
count__27934 = G__27951;
i__27935 = G__27952;
continue;
}
} else {
...
});})(each_fixture_fn,G__27931,env,once_fixtures,each_fixtures,vec__27928,ns,vars__$1))
);
});})(each_fixture_fn,G__27931,env,once_fixtures,each_fixtures,vec__27928,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1485228949006