...
var len__25873__auto___39710 = arguments.length;
var i__25874__auto___39711 = (0);
while(true){
if((i__25874__auto___39711 < len__25873__auto___39710)){
args__25880__auto__.push((arguments[i__25874__auto___39711]));

var G__39712 = (i__25874__auto___39711 + (1));
i__25874__auto___39711 = G__39712;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25881__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq39708){
var G__39709 = cljs.core.first.call(null,seq39708);
var seq39708__$1 = cljs.core.next.call(null,seq39708);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__39709,seq39708__$1);
});
...
return (p1__39713_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1485228968994