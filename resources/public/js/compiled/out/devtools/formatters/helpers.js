...
var G__39678 = devtools.prefs.pref.call(null,v);
v = G__39678;
continue;
} else {
return v;
...
var and__24786__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__24786__auto__){
var and__24786__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__24798__auto__ = (function (){try{if(!((value == null))){
...
}catch (e39691){var e__37282__auto__ = e39691;
return false;
}})();
if(cljs.core.truth_(or__24798__auto__)){
return or__24798__auto__;
} else {
var or__24798__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e39695){var e__37282__auto__ = e39695;
return false;
}})();
...
}catch (e39697){var e__37282__auto__ = e39697;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__24786__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__24786__auto__)){
var and__24786__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__24786__auto____$1){
...
var and__24786__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__24786__auto__)){
...
var or__24798__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__24798__auto__)){
return or__24798__auto__;
} else {
...
var and__24786__auto__ = (function (){var or__24798__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__24798__auto__)){
return or__24798__auto__;
} else {
...
var vec__39702 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39702,(0),null);
var name = cljs.core.nth.call(null,vec__39702,(1),null);
...
var and__24786__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__24786__auto__)){
...
var or__24798__auto__ = typeof value === 'string';
if(or__24798__auto__){
return or__24798__auto__;
} else {
var or__24798__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__39705_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39705_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1485228968938