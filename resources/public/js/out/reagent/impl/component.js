...
if((i < len)){
var k = (ks[i]);
var G__32162 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__32163 = (i + (1));
m = G__32162;
i = G__32163;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__32167 = c;
var G__32167__$1 = (((G__32167 == null))?null:G__32167.prototype);
if((G__32167__$1 == null)){
return null;
} else {
return (G__32167__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__32171 = c;
var G__32171__$1 = (((G__32171 == null))?null:G__32171.prototype);
if((G__32171__$1 == null)){
return null;
} else {
return (G__32171__$1["render"]);
}
})()));
});
...
return (function() { 
var G__32177__delegate = function (args){
var G__32175 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__32175) : reagent.impl.component.as_element.call(null,G__32175));
};
...
while (G__32178__i < G__32178__a.length) {G__32178__a[G__32178__i] = arguments[G__32178__i + 0]; ++G__32178__i;}
  args = new cljs.core.IndexedSeq(G__32178__a,0);
} 
return G__32177__delegate.call(this,args);};
G__32177.cljs$lang$maxFixedArity = 0;
G__32177.cljs$lang$applyTo = (function (arglist__32179){
var args = cljs.core.seq(arglist__32179);
return G__32177__delegate(args);
});
...
var _STAR_current_component_STAR_32182 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_32182;
}});
...
var G__32190 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__32190) {
...
return ((function (G__32190){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__32193 = reagent.impl.component.state_atom(c);
var G__32194 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__32193,G__32194) : cljs.core.reset_BANG_.call(null,G__32193,G__32194));
});
;})(G__32190))
...
var or__25059__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__32196_32198 = (c["cljsRatom"]);
if((G__32196_32198 == null)){
} else {
reagent.ratom.dispose_BANG_(G__32196_32198);
}
...
if(cljs.core.truth_((function (){var and__25047__auto__ = wrap;
...
var renders_32201 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_32202 = cljs.core.first(cljs.core.vals(renders_32201));
if((cljs.core.count(renders_32201) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_32201))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_32202)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_32202], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__25059__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__25059__auto__)){
return or__25059__auto__;
} else {
...
var render_fun__$1 = (function (){var or__25059__auto__ = render_fun;
if(cljs.core.truth_(or__25059__auto__)){
return or__25059__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__25059__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__25059__auto__)){
return or__25059__auto__;
} else {
...
var name__$1 = (function (){var G__32200 = name;
switch (G__32200) {
case "":
...
var elem = (function (){var G__32211 = (function (){var or__25059__auto__ = (function (){var G__32213 = c;
if((G__32213 == null)){
return null;
} else {
return (G__32213["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__25059__auto__)){
return or__25059__auto__;
...
return (G__32211["_currentElement"]);
}
})();
var name = (function (){var G__32214 = elem;
var G__32214__$1 = (((G__32214 == null))?null:(G__32214["type"]));
if((G__32214__$1 == null)){
return null;
} else {
return (G__32214__$1["displayName"]);
}
})();
var path = (function (){var G__32215 = elem;
var G__32215__$1 = (((G__32215 == null))?null:(G__32215["_owner"]));
var G__32215__$2 = (((G__32215__$1 == null))?null:reagent$impl$component$component_path(G__32215__$1));
if((G__32215__$2 == null)){
return null;
} else {
return [cljs.core.str(G__32215__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__25059__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__25059__auto__)){
return or__25059__auto__;
} else {
var G__32217 = c;
var G__32217__$1 = (((G__32217 == null))?null:G__32217.constructor);
if((G__32217__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__32217__$1);
}
}
})();
