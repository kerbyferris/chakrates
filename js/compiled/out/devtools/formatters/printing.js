...
var len__25873__auto___39719 = arguments.length;
var i__25874__auto___39720 = (0);
while(true){
if((i__25874__auto___39720 < len__25873__auto___39719)){
args__25880__auto__.push((arguments[i__25874__auto___39720]));

var G__39721 = (i__25874__auto___39720 + (1));
i__25874__auto___39720 = G__39721;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25881__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39716){
var G__39717 = cljs.core.first.call(null,seq39716);
var seq39716__$1 = cljs.core.next.call(null,seq39716);
var G__39718 = cljs.core.first.call(null,seq39716__$1);
var seq39716__$2 = cljs.core.next.call(null,seq39716__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__39717,G__39718,seq39716__$2);
});
...
if(cljs.core.truth_((function (){var or__24798__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25404__auto__,writer__25405__auto__,opt__25406__auto__){
return cljs.core._write.call(null,writer__25405__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__24786__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__24786__auto__){
var or__24798__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__24798__auto__)){
return or__24798__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39722_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__39722_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__39731__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__24798__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e39735){var e__37282__auto__ = e39735;
return false;
}})();
if(cljs.core.truth_(or__24798__auto__)){
return or__24798__auto__;
...
}catch (e39737){var e__37282__auto__ = e39737;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39742 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39743 = opts;
var map__39743__$1 = ((((!((map__39743 == null)))?((((map__39743.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39743.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39743):map__39743);
var markup_db = cljs.core.get.call(null,map__39743__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39742;
}});
...
;
var temp__4655__auto___39748 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___39748)){
var managed_print_level_39749 = temp__4655__auto___39748;
var _STAR_print_level_STAR_39747_39750 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39749;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39747_39750,managed_print_level_39749,temp__4655__auto___39748,writer,opts,job_fn){
return (function (p1__39745_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39745_SHARP_,null);
});})(_STAR_print_level_STAR_39747_39750,managed_print_level_39749,temp__4655__auto___39748,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39747_39750;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1485228969140