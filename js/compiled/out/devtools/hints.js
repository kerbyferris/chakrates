...
var reader = (function (){var or__24798__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__24798__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__24798__auto__)){
return or__24798__auto__;
} else {
return (128);
...
var map__40459 = top_item;
var map__40459__$1 = ((((!((map__40459 == null)))?((((map__40459.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40459.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40459):map__40459);
var file = cljs.core.get.call(null,map__40459__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40459__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40459__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40458){var _e = e40458;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___40461 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___40461)){
var seen_errors_40462 = temp__4655__auto___40461;
if(cljs.core.truth_(seen_errors_40462.has(self))){
} else {
seen_errors_40462.add(self);

var temp__4657__auto___40463 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___40463)){
var sense_40464 = temp__4657__auto___40463;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_40464)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1485228970741