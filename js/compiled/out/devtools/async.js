...
var o__37257__auto___40432 = (function (){var o__37257__auto__ = (function (){var o__37257__auto__ = Promise;
return goog.object.get(o__37257__auto__,"resolve").call(o__37257__auto__);
})();
return goog.object.get(o__37257__auto__,"then").call(o__37257__auto__,callback);
})();
goog.object.get(o__37257__auto___40432,"catch").call(o__37257__auto___40432,devtools.async.rethrow_outside_promise);
...
var G__40434_40435 = Error;
var target__37276__auto___40436 = G__40434_40435;
if(cljs.core.truth_(target__37276__auto___40436)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__40434_40435)].join('')),cljs.core.str("\n"),cljs.core.str("target__37276__auto__")].join('')));
}

goog.object.set(target__37276__auto___40436,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1485228970575